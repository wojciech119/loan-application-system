    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DecisionHistories", x => x.Id);
                    table.ForeignKey(
                        name: "FK_DecisionHistories_AspNetUsers_ChangedByUserId",
                        column: x => x.ChangedByUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_DecisionHistories_LoanApplications_LoanApplicationId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DecisionHistories_ChangedByUserId",
                table: "DecisionHistories",
                column: "ChangedByUserId");

            migrationBuilder.CreateIndex(
                name: "IX_DecisionHistories_LoanApplicationId",
                table: "DecisionHistories",
